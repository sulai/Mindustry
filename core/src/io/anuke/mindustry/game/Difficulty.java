...
public enum Difficulty {
    easy(4f, 2f, 1f, new DestrutiveHeuristic(b -> b instanceof Emitter)),
    normal(2f, 1f, 1f, new DestrutiveHeuristic(b -> b instanceof Smelter || b instanceof Emitter)),
    hard(1.5f, 0.5f, 0.75f, new DestrutiveHeuristic(b -> b instanceof Turret || b instanceof Emitter || b instanceof Drill || b instanceof Smelter)),
    insane(0.5f, 0.25f, 0.5f, new DestrutiveHeuristic(b -> b instanceof Emitter || b instanceof Drill || b instanceof Smelter || b instanceof Router)),
    purge(0.25f, 0.01f, 0.25f, new DestrutiveHeuristic(b -> b instanceof Emitter || b instanceof Drill || b instanceof Router
