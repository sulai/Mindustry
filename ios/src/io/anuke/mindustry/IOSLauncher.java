	...
	protected IOSApplication createApplication() {
		...
		Platform.instance = new Platform() {
			...
			public void shareFile(FileHandle file) {
				...
				UIApplication.getSharedApplication().getKeyWindow().getRootViewController().presentViewController(p, true, () -> io.anuke.ucore.util.Log.info("Success! Presented {0}", to));
			}
		};
